...
export const ApplicationFormScreen = () => {
  ...
  const validateAndSubmit = () => {
    ...
    if (!email.match(/^[^\s@]+@[^\s@]+\.[^\s@]+$/))
      return Alert.alert("Invalid Data", "Please provide a valid email.");
    ...
    if (!reason.trim())
      return Alert.alert("Required", "Please tell us why we should hire you.");
  ...
  return (
    <KeyboardAvoidingView
      ...
      keyboardVerticalOffset={Platform.OS === "ios" ? 90 : 20} // Offsets the navigation header height
    >
      <ScrollView
        ref={scrollViewRef}
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text
              style={[styles.contextCompany, { color: colors.secondaryText }]}
            >
              {job.company}
            </Text>
          </View>
